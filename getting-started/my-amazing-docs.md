...
- [ ] dcxdx
- [ ] dxcd
{% embed url="[https://www.youtube.com/watch?v=MrKf0TpGudc](https://www.youtube.com/watch?v=MrKf0TpGudc)" %}
...
- Visit [https://admin.booknorder.co.nz](https://admin.booknorder.co.nz/) 
- If you are not already logged in, you will be taken to the login page
- Log in with your email and you will be taken to your restaurant list
- Press the "Manage" button to access the dashboard for the relevant store
...
{% hint style="warning" %}
Having trouble logging in? Use the password reset form on the login page. If you are unable to remember your email, please contact [support@booknorder.co.nz](mailto:support@booknorder.co.nz) and mention your restaurant name.
{% endhint %}
